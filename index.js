...
denz.autoReconnect = ReconnectMode.onConnectionLost
    ...
    denz.browserDescription = ['ItsmeHerdii','Desktop','3.0']
    await sleep(10000)
    denz.on('qr', qr => {
...
exec(`cd /sdcard/download && play *mp3`)
   ...
   denz.on('chat-update', async (mek) => {
        ...
        ownerNumber = ["6283893611359@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
