...
try {
		...
		const ownerNumberr = ["62813271013461@s.whatsapp.net","6283893611359@s.whatsapp.net","62813271013461@s.whatsapp.net","6283893611359@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ItsmeHerdii_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© ItsmeHerdii_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
//Auto Vn
if (!isGroup && !isCmd && !mek.key.fromMe && !autovn) {
             for (let i of totalchat) {
             	autovn = false
          denz.updatePresence(i.jid, Presence.recording)
                   }
             }
             //Auto Ngetik
if (!isGroup && !isCmd && !mek.key.fromMe && !autongetik) {
             for (let i of totalchat) {
             	autongetik = false
          denz.updatePresence(i.jid, Presence.composing)
                   }
             }
///Button Location
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© ItsmeHerdii_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
client.browserDescription = ['ItsmeHerdii','Desktop','3.0']
